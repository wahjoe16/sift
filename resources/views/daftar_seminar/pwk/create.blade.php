                        ...
                        <div class="col-12">
                            <div class="box-body">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_2">Sertifikat pesantren mahasiswa baru</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_3" class="dropify" id="syarat_3">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_3">Sertifikat pesantren calon sarjana<sub> (Jika sudah ada)</sub></p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_4" class="dropify" id="syarat_4">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_4">Transkrip nilai yang di print SIAA program studi<sub> (Jika sudah ada)</sub></p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_5" class="dropify" id="syarat_5">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_5">Sertifikat TOEFL (Skor Minimal 475) jika sudah ada<sub> (Jika sudah ada)</sub></p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_6" class="dropify" id="syarat_6">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_6">Bukti bebas pinjaman perpustakaan</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_7" class="dropify" id="syarat_7">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_7">Sertifikat SKKFT (jika sudah ada)<sub> (Jika sudah ada)</sub></p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_8" class="dropify" id="syarat_8">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_8">Bukti KRS (pengambilan MK. Skripsi)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_9" class="dropify" id="syarat_9">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_9">Bukti pembayaran DPP Mk. Skripsi</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_10" class="dropify" id="syarat_10">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_10">Bukti pembayaran sidang pembahasan</p>
                                </div>
                            </div>
                        </div>
                    </div>
