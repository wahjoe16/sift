                        ...
                        <div class="col-12">
                            <div class="box-body">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <p class="col-form-label text-center" for="syarat_1">Formulir Biodata Alumni</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_2" class="dropify" id="syarat_2">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_2">Formulir Pembuatan Ijazah</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_3" class="dropify" id="syarat_3">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_3">Fotocopy Kwitansi DPP/UKT</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_4" class="dropify" id="syarat_4">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_4">Fotocopy Kwitansi Bimbingan TA (dari awal pengambilan)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_5" class="dropify" id="syarat_5">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_5">Fotocopy Kwitansi Sidang TA</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_6" class="dropify" id="syarat_6">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_6">Fotocopy Kwitansi Seminar TA</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_7" class="dropify" id="syarat_7">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_7">Fotocopy Sertifikat Pesantren Calon Sarjana (paling lama 1 Tahun setelah terbit)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_8" class="dropify" id="syarat_8">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_8">Formulir Rencana Studi (FRS)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_9" class="dropify" id="syarat_9">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_9">Bukti Penyerahan Draft TA (4 Eksemplar) Memakai Mika Biru</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_10" class="dropify" id="syarat_10">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_10">Bukti Bebas Perpustakaan Pusat UNISBA</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_11" class="dropify" id="syarat_11">
                                    <p class="col-form-label text-center" for="syarat_11">Bukti Bebas Perpustakaan TI</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_12" class="dropify" id="syarat_12">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_12">Transkrip Nilai Terakhir</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_13" class="dropify" id="syarat_13">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_13">Persetujuan Sidang dari Dosen Pembimbing (Kartu Bimbingan Asli)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_14" class="dropify" id="syarat_14">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_14">Fotocopy Sertifikat TOEFL (paling lama 1 Tahun setelah terbit)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_15" class="dropify" id="syarat_15">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_15">Fotocopy Sertifikat PPMB</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_16" class="dropify" id="syarat_16">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_16">Bebas Pinjaman / Tunggakan</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_17" class="dropify" id="syarat_17">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_17">Menghadiri Seminar / Sidang minimal 3 kali</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_18" class="dropify" id="syarat_18">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_18">Fotocopy Sertifikat Academic Writing and Conversation <sub>(jika ada)</sub></p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_19" class="dropify" id="syarat_19">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_19">Form Hafalan Surat Al-Quran (minimal 25 surat)</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <input type="file" name="syarat_20" class="dropify" id="syarat_20">
                                    <p for="exampleInputEmail2" class="col-form-label text-center" for="syarat_20">Print out bukti pengecekan Plagiarisme < 25% (sebelum sidang)</p>
                                </div>
                            </div>
                        </div>
                    </div>
